  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className=" text-green-700 text-sm mt-4 cursor-pointer hover:text-green-500">Forget password?</div>
        <div className="flex justify-center">
          <button type="submit" className="my-8 bg-blue-500 hover:bg-blue-200 cursor-pointer hover:text-blue-700 py-2 rounded-lg text-white w-[200px]">Login</button>
        </div>
      </form>
    </div>
  );
